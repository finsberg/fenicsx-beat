...
To get an overview of the project, read the [documentation](https://finsberg.github.io/fenicsx-beat). Here are some resources to help you get started with open source contributions:
